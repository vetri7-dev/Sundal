...
class CouponRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'type.in' => __('The discount type must be either percentage or flat amount.'),
            'discount_amount.required' => __('The discount amount is required.'),
            'discount_amount.min' => __('The discount amount must be greater than 0.'),
            'maximum_spend.gte' => __('The maximum spend must be greater than or equal to minimum spend.'),
