...
class MercadoPagoController extends Controller
{
    ...
    public function processInvoicePayment(Request $request, Invoice $invoice)
    {
        try {
            ...
            // Set back URLs
            $preference->back_urls = [
                "success" => route('invoices.payment', $invoice->payment_token),
                "failure" => route('invoices.payment', $invoice->payment_token),
                "pending" => route('invoices.payment', $invoice->payment_token)
            ];
