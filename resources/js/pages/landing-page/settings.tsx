...
export default function LandingPageSettings() {
  ...
  const { settings, isSaas, flash } = usePage<PageProps>().props;
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("See POS System in Action")}
                      />
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("Explore our intuitive interface and powerful features designed to streamline your retail operations.")}
                        rows={3}
                      />
                    </div>
                  </div>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-3">
                              ...
                              <Input
                                ...
                                placeholder={t("POS Dashboard Overview")}
                              />
                            </div>
                          </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <Textarea
                              ...
                              placeholder={t("Comprehensive dashboard with sales analytics and inventory management")}
                              rows={2}
                            />
                          </div>
                        </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("Why Choose Our POS System?")}
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("We\'re not just another point-of-sale platform.")}
                        rows={3}
                      />
                    </div>
                  </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div className="space-y-3">
                            ...
                            >
                              ...
                              <option value="check-circle">{t('Check Circle')}</option>
                          ...
                          <div className="space-y-3 md:col-span-1">
                            ...
                            <Textarea
                              ...
                              placeholder={t("Get your POS system running in under 5 minutes.")}
                              rows={3}
                            />
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          <div className="space-y-3">
                            ...
                            <Input
                              ...
                              placeholder={t("How does the POS system work?")}
                            />
                          </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <Textarea
                              ...
                              placeholder={t("Our POS system allows you to process sales, manage inventory, and track customer data efficiently.")}
                              rows={3}
                            />
                          </div>
                        </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("Stay Updated with POS System")}
                      />
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("Get the latest updates and retail management tips.")}
                        rows={3}
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("Have questions about our POS system? We\'d love to hear from you.")}
                        rows={3}
                      />
                    </div>
                    ...
                    {(getSectionData('contact').faqs || []).map((faq, index) => (
                      <div key={index} className="p-4 border rounded-lg space-y-4">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-3">
                            <Label htmlFor={`contact_faq_${index}_answer`}>{t("Answer")}</Label>
                            <Textarea
                  ...
                  <div className="space-y-6">
                    {['product', 'company', 'support', 'legal'].map((category) => (
                      <div key={category} className="space-y-4">
                        ...
                        <h4 className="font-medium">{getSectionData('footer').section_titles?.[category] || category.charAt(0).toUpperCase() + category.slice(1)} {t("Links")}</h4>
