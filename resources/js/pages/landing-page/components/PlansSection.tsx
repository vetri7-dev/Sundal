              ...
              <div className="relative z-10 flex flex-col h-full p-6 pt-8">
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-white/50 rounded-lg p-2 text-center">
                      <div className="text-lg font-bold" style={{ color: brandColor }}>{plan.stats?.workspaces || 'N/A'}</div>
                      <div className="text-xs text-muted-foreground">{t("Workspaces")}</div>
                    </div>
                    <div className="bg-white/50 rounded-lg p-2 text-center">
                    ...
                    <div className="bg-white/50 rounded-lg p-2 text-center">
                      <div className="text-lg font-bold" style={{ color: brandColor }}>{plan.stats?.projects || 'N/A'}</div>
                ...
                <div className="mb-6 flex-1">
                  ...
                  <ul className="space-y-2.5">
                    {/* Dynamic features from plan.features or plan.module */}
