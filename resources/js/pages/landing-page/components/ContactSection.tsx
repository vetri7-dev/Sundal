...
export default function ContactSection({ flash, settings, sectionData, brandColor = '#3b82f6' }: ContactSectionProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    post(route('landing-page.contact'), {
      onSuccess: (page) => {
        reset();
        const successMessage = page.props.flash?.success || t('Thank you for your message. We will get back to you soon!');
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: t('Email Us'),
      content: settings?.contact_email || 'support@taskly.com',
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
          ...
          <div>
            <div className="bg-white border border-gray-200 rounded-xl p-8">
              ...
              {flash?.success && !flash.success.toLowerCase().includes('subscrib') && (
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  {sectionData?.info_description || t('We\'re here to help and answer any question you might have.')}
                </p>
              </div>
