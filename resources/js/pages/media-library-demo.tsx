...
import { Upload, Search, X, Plus, Info, Copy, Download, MoreHorizontal, Image as ImageIcon, Calendar, HardDrive, BarChart3, FileText, Archive, File } from 'lucide-react';
                  ...
                  {selectedMediaInfo.mime_type.startsWith('image/') ? (
                    ...
                    <div className="flex flex-col items-center justify-center p-8">
                      ...
                      <span className="text-sm text-muted-foreground mt-3">
                        {selectedMediaInfo.file_name.split('.').pop()?.toUpperCase()} File
                      </span>
                    </div>
                  )}
                </div>
