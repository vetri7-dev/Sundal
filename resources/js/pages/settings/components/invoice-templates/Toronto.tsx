        ...
        <div style={{ padding: '15px 30px' }}>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <tbody>
              <tr>
                <td style={{ padding: '15px 30px', verticalAlign: 'top' }}>
                  <h3 style={{ textTransform: 'uppercase', fontSize: '30px', fontWeight: 'bold', marginBottom: '15px' }}>{translate('INVOICE')}</h3>
                  <table style={{ width: '100%' }}>
                    <tbody>
                      ...
                      <tr>
                        <td style={{ padding: 0 }}>{translate('Invoice Date')}: {window.appSettings.formatDateTime(new Date(invoiceData.invoice_date),false)}<br />{translate('Due Date')}: {window.appSettings.formatDateTime(new Date(invoiceData.due_date),false)}</td>
                      </tr>
                    </tbody>
                  </table>
                </td>
