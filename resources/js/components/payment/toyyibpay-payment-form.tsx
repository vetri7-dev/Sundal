        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="border-t pt-4">
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-lg font-bold">{currency} {(() => { if (typeof window !== "undefined" && window.appSettings?.formatCurrency) { return window.appSettings.formatCurrency(planPrice, { showSymbol: true }); } return planPrice.toFixed(2); })()}</span>
            </div>
