...
interface PayHereInvoiceModalProps {
    isOpen: boolean;
    onClose: () => void;
    invoice: any;
    amount: number;
...
export function PayHereInvoiceModal({ isOpen, onClose, invoice, amount }: PayHereInvoiceModalProps) {
    ...
    const handlePayment = async () => {
        ...
        try {
            const response = await fetch(route('payhere.invoice.payment.link', invoice?.payment_token), {
                method: 'POST',
                headers: {
