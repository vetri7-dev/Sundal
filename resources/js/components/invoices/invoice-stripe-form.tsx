...
const CheckoutForm = ({ invoice, amount, onSuccess, onCancel }: Omit<InvoiceStripeFormProps, 'stripeKey'>) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    // Process payment through invoice payment route
...
export function InvoiceStripeForm({ invoice, stripeKey, amount, onSuccess, onCancel }: InvoiceStripeFormProps) {
  const { t } = useTranslation();
