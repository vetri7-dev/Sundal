...
export function InvoiceTapForm({ 
  invoice, 
  tapPublicKey,
  amount,
  onSuccess, 
  ...
  if (!tapPublicKey) {
    return <div className="p-4 text-center text-red-500">{t('Tap not configured')}</div>;
  }
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold">{t('Tap Payment')}</h3>
      </div>
