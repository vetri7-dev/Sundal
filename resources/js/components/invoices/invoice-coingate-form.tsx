...
interface InvoiceCoinGateFormProps {
    invoice: any;
    amount: number;
    onSuccess: () => void;
    onCancel: () => void;
...
export function InvoiceCoinGateForm({ invoice, amount, onSuccess, onCancel }: InvoiceCoinGateFormProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Create form and submit to trigger CoinGate redirect
        const form = document.createElement('form');
        form.method = 'POST';
        form.action = route('invoices.payment.process', invoice.payment_token);
        ...
        <div className="space-y-4">
            ...
            <div className="bg-muted p-4 rounded-lg">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-bold">{formatCurrency(amount.toFixed(2))}</span>
                </div>
