...
<a name="method_getBasketId" class="anchor"></a>
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code lang="php">\YooKassa\Model\AmountInterface OR array OR null</code> | amount  | Сумма, которая вернется на электронный сертификат |

**Returns:** self - 


<a name="method_setBasketId" class="anchor"></a>
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code lang="php">string OR null</code> | basket_id  | Идентификатор корзины возврата, сформированной в НСПК |
