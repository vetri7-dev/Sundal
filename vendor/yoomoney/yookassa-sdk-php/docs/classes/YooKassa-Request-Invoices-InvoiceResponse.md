...
# Class: \YooKassa\Request\Invoices\InvoiceResponse
### Namespace: [\YooKassa\Request\Invoices](../namespaces/yookassa-request-invoices.md)
---
**Summary:**

Класс, представляющий модель InvoiceResponse.

**Description:**

Объект ответа, возвращаемого API при запросе конкретного счета.
