...
# Class: \YooKassa\Model\Payment\Confirmation\ConfirmationCodeVerification
### Namespace: [\YooKassa\Model\Payment\Confirmation](../namespaces/yookassa-model-payment-confirmation.md)
---
**Summary:**

Класс, представляющий модель ConfirmationCodeVerification.
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](../classes/YooKassa-Model-Payment-Confirmation-ConfirmationCodeVerification.md#method___construct) |  |  |
...
---
### Details
* File: [lib/Model/Payment/Confirmation/ConfirmationCodeVerification.php](../../lib/Model/Payment/Confirmation/ConfirmationCodeVerification.php)
...
* Class Hierarchy:  
  ...
  * \YooKassa\Model\Payment\Confirmation\ConfirmationCodeVerification

* See Also:
  * [Сценарий при котором необходимо получить одноразовый код от плательщика для подтверждения платежа.](https://yookassa.ru/developers/api)
...
**Details:**
* Inherited From: [\YooKassa\Model\Payment\Confirmation\ConfirmationCodeVerification](../classes/YooKassa-Model-Payment-Confirmation-ConfirmationCodeVerification.md)
