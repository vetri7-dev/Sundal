...
# Class: \YooKassa\Model\Invoice\InvoiceCancellationDetails
...
| ----------:| ---- | ---- | ------- |
| public | [$party](../classes/YooKassa-Model-Invoice-InvoiceCancellationDetails.md#property_party) |  | Участник процесса, который принял решение об отмене счета. |
| public | [$reason](../classes/YooKassa-Model-Invoice-InvoiceCancellationDetails.md#property_reason) |  | Причина отмены счета. |
...
| public | [getParty()](../classes/YooKassa-Model-Invoice-InvoiceCancellationDetails.md#method_getParty) |  | Возвращает party. |
| public | [getReason()](../classes/YooKassa-Model-Invoice-InvoiceCancellationDetails.md#method_getReason) |  | Возвращает reason. |
...
| public | [setParty()](../classes/YooKassa-Model-Invoice-InvoiceCancellationDetails.md#method_setParty) |  | Устанавливает party. |
| public | [setReason()](../classes/YooKassa-Model-Invoice-InvoiceCancellationDetails.md#method_setReason) |  | Устанавливает reason. |
...
---
### Details
* File: [lib/Model/Invoice/InvoiceCancellationDetails.php](../../lib/Model/Invoice/InvoiceCancellationDetails.php)
* Package: YooKassa\Model
* Class Hierarchy: 
  * [\YooKassa\Common\AbstractObject](../classes/YooKassa-Common-AbstractObject.md)
  * \YooKassa\Model\Invoice\InvoiceCancellationDetails
...
**Details:**
* Inherited From: [\YooKassa\Model\Invoice\InvoiceCancellationDetails](../classes/YooKassa-Model-Invoice-InvoiceCancellationDetails.md)
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code lang="php">string OR null</code> | party  | Участник процесса, который принял решение об отмене счета. Возможные значения:  * ~`merchant` — продавец товаров и услуг (вы); * ~`yoo_money` — ЮKassa. |
