...
# Class: \YooKassa\Model\Payment\PaymentMethod\PaymentMethodSberbank
### Namespace: [\YooKassa\Model\Payment\PaymentMethod](../namespaces/yookassa-model-payment-paymentmethod.md)
---
**Summary:**

Класс, представляющий модель PaymentMethodSberbank.
...
| public | [$phone](../classes/YooKassa-Model-Payment-PaymentMethod-PaymentMethodSberbank.md#property_phone) |  | Телефон пользователя, на который зарегистрирован аккаунт в SberPay. Указывается в формате [ITU-T E.164](https://ru.wikipedia.org/wiki/E.164), например ~`79000000000`. |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](../classes/YooKassa-Model-Payment-PaymentMethod-PaymentMethodSberbank.md#method___construct) |  |  |
...
| public | [getPhone()](../classes/YooKassa-Model-Payment-PaymentMethod-PaymentMethodSberbank.md#method_getPhone) |  | Возвращает номер телефона в формате ITU-T E.164. |
...
| public | [setPhone()](../classes/YooKassa-Model-Payment-PaymentMethod-PaymentMethodSberbank.md#method_setPhone) |  | Устанавливает номер телефона в формате ITU-T E.164. |
...
---
### Details
* File: [lib/Model/Payment/PaymentMethod/PaymentMethodSberbank.php](../../lib/Model/Payment/PaymentMethod/PaymentMethodSberbank.php)
...
* Class Hierarchy:   
  ...
  * \YooKassa\Model\Payment\PaymentMethod\PaymentMethodSberbank
...
**Details:**
* Inherited From: [\YooKassa\Model\Payment\PaymentMethod\PaymentMethodSberbank](../classes/YooKassa-Model-Payment-PaymentMethod-PaymentMethodSberbank.md)
...
**Returns:** string|null - Номер телефона в формате ITU-T E.164
...
```php
public setPhone(string|null $phone) : self
```
