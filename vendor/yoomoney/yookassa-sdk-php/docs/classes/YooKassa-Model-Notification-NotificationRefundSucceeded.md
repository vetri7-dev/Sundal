...
| public | [fromArray()](../classes/YooKassa-Model-Notification-NotificationRefundSucceeded.md#method_fromArray) |  | Конструктор объекта нотификации. |
...
| public | [setObject()](../classes/YooKassa-Model-Notification-NotificationRefundSucceeded.md#method_setObject) |  | Устанавливает объект с информацией о возврате, уведомление о которой хранится в текущем объекте. |
...
#### public $object : \YooKassa\Model\Refund\RefundInterface
---
***Description***

Объект с информацией о возврате

**Type:** <a href="../classes/YooKassa-Model-Refund-RefundInterface.html"><abbr title="\YooKassa\Model\Refund\RefundInterface">RefundInterface</abbr></a>
...
| Type | Description |
| ---- | ----------- |
| \Exception|\YooKassa\Common\Exceptions\InvalidPropertyValueException | Генерируется если значение типа нотификации или события не равны "notification" и "refund.succeeded" соответственно, что может говорить о том, что переданные в конструктор данные не являются уведомлением нужного типа. |
...
#### public getObject() : \YooKassa\Model\Refund\RefundInterface
...
**Returns:** \YooKassa\Model\Refund\RefundInterface - Объект с информацией о возврате
...
```php
public setObject(\YooKassa\Model\Refund\RefundInterface|array $object) : self
```
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code lang="php">\YooKassa\Model\Refund\RefundInterface OR array</code> | object  |  |
