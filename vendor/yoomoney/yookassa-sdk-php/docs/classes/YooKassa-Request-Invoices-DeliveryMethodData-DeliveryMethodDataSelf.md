...
# Class: \YooKassa\Request\Invoices\DeliveryMethodData\DeliveryMethodDataSelf
### Namespace: [\YooKassa\Request\Invoices\DeliveryMethodData](../namespaces/yookassa-request-invoices-deliverymethoddata.md)
---
**Summary:**

Класс, представляющий модель DeliveryMethodDataSelf.
...
| public | [$type](../classes/YooKassa-Request-Invoices-DeliveryMethodData-DeliveryMethodDataSelf.md#property_type) |  | Код способа доставки счета пользователю. |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](../classes/YooKassa-Request-Invoices-DeliveryMethodData-DeliveryMethodDataSelf.md#method___construct) |  |  |
...
---
### Details
* File: [lib/Request/Invoices/DeliveryMethodData/DeliveryMethodDataSelf.php](../../lib/Request/Invoices/DeliveryMethodData/DeliveryMethodDataSelf.php)
...
* Class Hierarchy:  
  ...
  * \YooKassa\Request\Invoices\DeliveryMethodData\DeliveryMethodDataSelf
...
**Details:**
* Inherited From: [\YooKassa\Request\Invoices\DeliveryMethodData\DeliveryMethodDataSelf](../classes/YooKassa-Request-Invoices-DeliveryMethodData-DeliveryMethodDataSelf.md)
