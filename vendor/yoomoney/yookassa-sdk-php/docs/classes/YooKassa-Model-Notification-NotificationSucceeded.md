...
| public | [fromArray()](../classes/YooKassa-Model-Notification-NotificationSucceeded.md#method_fromArray) |  | Конструктор объекта нотификации о возможности подтверждения платежа. |
...
| public | [setObject()](../classes/YooKassa-Model-Notification-NotificationSucceeded.md#method_setObject) |  | Устанавливает объект с информацией о платеже, уведомление о которой хранится в текущем объекте. |
...
**Returns:** \YooKassa\Model\Payment\PaymentInterface - Объект с информацией о платеже
