...
| public | [fromArray()](../classes/YooKassa-Model-Notification-NotificationDealClosed.md#method_fromArray) |  | Конструктор объекта нотификации. |
...
| public | [setObject()](../classes/YooKassa-Model-Notification-NotificationDealClosed.md#method_setObject) |  | Устанавливает объект с информацией о сделке, уведомление о которой хранится в текущем объекте. |
...
#### public $object : \YooKassa\Model\Deal\DealInterface
---
***Description***

Объект с информацией о сделке

**Type:** <a href="../classes/YooKassa-Model-Deal-DealInterface.html"><abbr title="\YooKassa\Model\Deal\DealInterface">DealInterface</abbr></a>
...
| Type | Description |
| ---- | ----------- |
| \Exception|\YooKassa\Common\Exceptions\InvalidPropertyValueException | Генерируется если значение типа нотификации или события не равны "notification" и "deal.closed" соответственно, что может говорить о том, что переданные в конструктор данные не являются уведомлением нужного типа. |
...
#### public getObject() : \YooKassa\Model\Deal\DealInterface
...
**Returns:** \YooKassa\Model\Deal\DealInterface - Объект с информацией о сделке
...
```php
public setObject(\YooKassa\Model\Deal\DealInterface|array $object) : self
```
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code lang="php">\YooKassa\Model\Deal\DealInterface OR array</code> | object  |  |
