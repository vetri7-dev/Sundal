...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('current_business')->nullable();
            ...
            $table->unsignedBigInteger('timer_project_id')->nullable();
            $table->unsignedBigInteger('timer_task_id')->nullable();
            $table->unsignedBigInteger('timer_entry_id')->nullable();
            $table->timestamp('timer_started_at')->nullable();
            $table->text('timer_description')->nullable();
            $table->decimal('timer_elapsed_seconds', 10, 3)->default(0);
        ...
        if (isSaasMode() && Schema::hasColumn('users', 'referral_code')){
